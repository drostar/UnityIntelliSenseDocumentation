@echo off
REM Copies all Unity XML Documentation files into the appropriate Unity 4.6 application subfolders for the default installation location


REM Copying to Program Files folder requires administrative privilages.
:: BatchGotAdmin
:-------------------------------------
